...
public class UnDirUnWeighted {
     private int vertices;
    private LinkedList<Integer>[] adjacencyList;

    public UnDirUnWeighted(int vertices) {
    ...
    public void removeEdge(int source, int destination) {
        ...
        adjacencyList[destination].remove((Integer) source); 
    ...
    public static void main(String[] args) {
        ...
        UnDirUnWeighted graph = new UnDirUnWeighted(vertices);
